...
echo "En VNF:ctrl arrancar controlador SDN"
...
sleep 45
echo "Ryu se encuentra operando"

## 2. En VNF:cpe agregar un bridge y sus vxlan y activar el modo SDN
...
## ACTIVAR EL MODO SDN EN VNF:ACCESS
...
$CTRL_EXEC sudo chmod 666 /var/run/openvswitch/db.sock
...
curl -X POST -d @json_qos/to_voipgw.json http://$IPCTRL:8080/qos/rules/0000000000000003
